---
title: "Manual"
description: "Task-focused guides for building Canvas2D scenes with EASEL.js."
sidebar:
  order: 1
...
- [Understand the renderer model](/manual/renderer-model/) before choosing effects or materials.
- [Set up cameras and controls](/manual/cameras-and-controls/) for pointer and keyboard-friendly interaction.
- [Create geometry and materials](/manual/geometry-and-materials/) from CPU vertex channels.
