...
export const meta = {
  ...
  name: "Extrude Along Splines",
  category: "canvas",
  description:
    "Shape extrusion and a CPU tube follow authored Catmull-Rom points; browser spline loaders are intentionally omitted.",
};
...
const plate = new THREE.ExtrudeGeometry(shape, { depth: 0.5, steps: 3 });
const ribbon = new THREE.TubeGeometry(new THREE.CatmullRomCurve3(points), 28, 0.16, 8);`;
