...
export const meta = {
  ...
  category: "canvas",
  description:
    "NURBSCurve and NURBSSurface are sampled into CPU TubeGeometry and ParametricGeometry.",
};
...
const curve = new NURBSCurve(degree, knots, controlPoints);
const geometry = new THREE.TubeGeometry(curve, 42, 0.22, 12);
const surface = new NURBSSurface(degree1, degree2, knots1, knots2, surfaceControlPoints);
const surfaceGeometry = new ParametricGeometry((u, v, target) => surface.getPoint(u, v, target), 18, 18);`;
