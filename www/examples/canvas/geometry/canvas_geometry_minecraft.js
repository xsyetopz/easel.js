...
export const meta = {
  ...
  category: "canvas",
  description:
    "A small authored voxel village uses shared BoxGeometry and flat CPU materials instead of a texture-atlas loader.",
};
...
const atlas = loader.load("textures/minecraft/atlas.png");
