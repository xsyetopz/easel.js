...
export const meta = {
  ...
  category: "canvas",
  description:
    "Click the canvas to cycle authored control points; a CPU Catmull-Rom tube and control polyline rebuild in place.",
};
...
points[selected].set(pointer.x, pointer.y, 0);
curve.points = points;
tube.geometry = new THREE.TubeGeometry(curve, 36, 0.2, 8);`;
