...
export const meta = {
  ...
  name: "UltraHDR texture loader",
  category: "canvas",
  description:
    "UltraHDR texture demonstrated on CPU geometry. EASEL has no native UltraHDR decoder; BasicMaterial stands in for HDR sampled material.",
};
