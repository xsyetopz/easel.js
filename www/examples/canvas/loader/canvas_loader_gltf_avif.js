...
export const meta = {
  ...
  name: "glTF AVIF loader",
  category: "canvas",
  description:
    "glTF with AVIF textures demonstrated as CPU geometry. EASEL has no native glTF AVIF parser; procedural geometry stands in for parsed mesh data.",
};
