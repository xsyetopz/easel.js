...
export const meta = {
  ...
  name: "EXR texture loader",
  category: "canvas",
  description:
    "EXR HDR texture demonstrated on CPU geometry. EASEL has EXRExporter but no EXR texture loader; BasicMaterial stands in for HDR sampled material.",
};
