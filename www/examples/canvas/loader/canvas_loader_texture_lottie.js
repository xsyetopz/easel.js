...
export const meta = {
  ...
  name: "Lottie texture loader",
  category: "canvas",
  description:
    "Lottie animation texture demonstrated on CPU geometry. EASEL has no native Lottie renderer; BasicMaterial stands in for animated texture data.",
};
