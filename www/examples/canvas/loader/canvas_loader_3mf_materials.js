...
export const meta = {
  ...
  name: "3MF materials loader",
  category: "canvas",
  description:
    "3MF mesh with materials demonstrated as CPU geometry. EASEL has no native 3MF parser; procedural geometry with Lambert material stands in for parsed mesh data.",
};
