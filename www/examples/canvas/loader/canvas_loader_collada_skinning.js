...
export const meta = {
  ...
  name: "Collada skinning loader",
  category: "canvas",
  description:
    "Collada mesh with skinning demonstrated as CPU geometry. EASEL has no native Collada parser; procedural geometry stands in for parsed mesh data.",
};
