...
export const meta = {
  ...
  name: "FBX NURBS loader",
  category: "canvas",
  description:
    "FBX mesh with NURBS surfaces demonstrated as CPU geometry. EASEL has no native FBX parser; procedural geometry stands in for parsed mesh data.",
};
