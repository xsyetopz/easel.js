...
export const meta = {
  ...
  name: "3D Tiles loader",
  category: "canvas",
  description:
    "3D Tiles streaming dataset demonstrated as CPU geometry. EASEL has no native 3D Tiles parser; procedural geometry stands in for tiled mesh data.",
};
