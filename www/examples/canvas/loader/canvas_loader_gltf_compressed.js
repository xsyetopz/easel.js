...
export const meta = {
  ...
  name: "glTF compressed loader",
  category: "canvas",
  description:
    "glTF with DRACO/Meshopt compression demonstrated as CPU geometry. EASEL has no native compressed glTF parser; procedural geometry stands in for decoded mesh data.",
};
