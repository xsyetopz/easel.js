...
export const meta = {
  ...
  name: "MD2 control loader",
  category: "canvas",
  description:
    "MD2 animated mesh with control demonstrated as CPU geometry. EASEL has no native MD2 parser; procedural geometry stands in for parsed mesh data.",
};
