...
export const meta = {
  ...
  name: "Collada kinematics loader",
  category: "canvas",
  description:
    "Collada mesh with kinematic joints demonstrated as CPU geometry. EASEL has no native Collada parser; procedural geometry stands in for parsed mesh data.",
};
