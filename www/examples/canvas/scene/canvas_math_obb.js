...
export const meta = {
  id: "webgl_math_obb",
  name: "Oriented Box Math",
  category: "canvas",
  description: "Two rotating boxes use the CPU OBB intersection helper.",
};
...
const a = new THREE.OBB().fromBox3(boxA);
const b = new THREE.OBB().fromBox3(boxB);
const overlaps = a.intersectsOBB(b);`;
