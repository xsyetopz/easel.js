...
export const meta = {
  ...
  name: "Point Billboards",
  category: "canvas",
  description:
    "A deterministic CPU point cloud uses integer-radius Points rasterization in place of shader billboards.",
};
...
const points = new THREE.Points(geometry, new THREE.PointsMaterial({ color: 0x73d5ec, size: 4, map: spriteTexture }));
scene.add(points);`;
