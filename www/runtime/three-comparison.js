...
export const THREE_COMPARISON_ADAPTER_IDS = Object.freeze([
  ...
  "camera_arcball_projection",
  "camera_arcball_compound_projection",
  "camera_fly_projection",
  "camera_fly_turn_projection",
  "camera_fly_sprint_compound_projection",
  "camera_sprint_projection",
  "camera_sprint_compound_projection",
  "camera_sprint_turn_projection",
  "camera_orbit_compound_projection",
  "camera_ortho_arcade_projection",
  "camera_focus_projection",
  "camera_focus_compound_projection",
  "camera_smooth_projection",
  "camera_cine_focus_projection",
  "camera_arcstep_projection",
  "camera_fastforward_projection",
  "camera_persist_projection",
  "camera_hoist_projection",
  "misc_exporter_draco",
  "misc_exporter_usdz",
  "webgl_helpers",
  "webgl_loader_3dm",
...
function classifyAdapter(id) {
  ...
  if (id.startsWith("camera_")) return { kind: "controls" };
  if (id === "webgl_helpers") return { kind: "geometry" };
  if (
