...
/** Two-dimensional cubic Bezier curve with four control points. */
export class CubicBezierCurve extends Curve {
  ...
  override clone(): CubicBezierCurve {
    return new CubicBezierCurve(this.#v0, this.#v1, this.#v2, this.#v3).copy(
      this,
    );
  }

  /** Copies values from another cubic curve. */
