...
export class EdgesGeometry extends Geometry {
	 ...
	 * @param {number} [thresholdAngle=1] In degrees.
	 */
...
/**
 * @param {ArrayLike<number>} srcPositions
 * @param {number} i
 * @param {number} j
 * @param {number} k
 * @returns {{ nx: number, ny: number, nz: number }}
 */
function _faceNormal(srcPositions, i, j, k) {
 ...
 */
function _buildEdgeMap(indexList, srcPositions) {
